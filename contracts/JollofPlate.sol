...
// JollofPlate helps your migrate your existing Uniswap LP tokens to JollofSwap LP ones
contract JollofPlate {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'JollofSwap: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'JollofPlate: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'JollofPlate: INSUFFICIENT_B_AMOUNT');
    }
